...
plusOneBtn.addEventListener('click', function() {
  if(clickValue > clickPowerPrice.innerHTML) {
    ...
    clickPowerPrice.innerHTML = Math.floor(clickPowerPrice.innerHTML * 2.4);
    setLocalStorage();
  }
});
...
plusTenBtn.addEventListener('click', function() {
  if(clickValue > clickPowerPriceTen.innerHTML) {
    ...
    clickPowerPriceTen.innerHTML = Math.floor(clickPowerPriceTen.innerHTML * 2.4);
    setLocalStorage();
  }
});
...
plusSecBtn.addEventListener('click', function() {
  if(clickValue > plusSecPrice.innerHTML) {
    ...
    plusSecPrice.innerHTML = Math.floor(plusSecPrice.innerHTML * 2.4);
    autoBonus++
    setLocalStorage();
  }
});
...
plusTenSecBtn.addEventListener('click', function() {
  if(clickValue > plusTenSecPrice.innerHTML) {
    ...
    plusTenSecPrice.innerHTML = Math.floor(plusTenSecPrice.innerHTML * 2.4);
    autoBonus += 10;
    setLocalStorage();
  }
});
...
//       setProgress(click);
//       clickValue += 10;
//       clickCounter.innerHTML = +(clickCounter.innerHTML) + 10;
//       if(click === denominator || click >= denominator) {
//         denominator *= 2.5;
//         click = 0;
//         lvl.innerHTML = lvlValue++;
